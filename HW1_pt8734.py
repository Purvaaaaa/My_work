...
#TASK 3: Answeres:-
# Answer 1:User ID-asamant, password-Temp123 and user ID-skharel, password-Life15$ combination(s) in the given table are present in the database.
#
# Answer 2: aissa and bjha userid(s) are present in the database, but the password does not match the password(s) in the given table
# Answer 3:Ally!  userid does not meet the requirements of a userid
